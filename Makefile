...
#   5. make monitoring     — Deploy monitoring stack (depin-pi3-mon)
#   6. make exporters-all  — Node exporters on all nodes
#   7. make storage-prep   — Prepare 500 GB disk (depin-pi3-1)
#   8. make deploy-bandwidth — Bandwidth DePIN (depin-pi4)
#   *** WAIT 72 HOURS — VERIFY STABILITY ***
#   9. make deploy-storage — Storage DePIN (depin-pi3-1)
#  10. make deploy-indexing — Indexing DePIN (depin-pi3-2)
#  11. make deploy-compute — Compute DePIN (depin-jetson)
...
base-pi4:
	$(call ssh_run,depin-pi4,$(PI4_IP),$(SCRIPTS)/01-base-setup.sh pi4)

base-pi3-1:
	$(call ssh_run,depin-pi3-1,$(PI3_1_IP),$(SCRIPTS)/01-base-setup.sh pi3-1)

base-pi3-2:
	$(call ssh_run,depin-pi3-2,$(PI3_2_IP),$(SCRIPTS)/01-base-setup.sh pi3-2)

base-pi3-mon:
	$(call ssh_run,depin-pi3-mon,$(PI3_MON_IP),$(SCRIPTS)/01-base-setup.sh pi3-mon)

base-jetson:
	$(call ssh_run,depin-jetson,$(JETSON_IP),$(SCRIPTS)/01-base-setup.sh jetson)
...
secure-pi4:
	$(call ssh_run,depin-pi4,$(PI4_IP),$(SCRIPTS)/02-security.sh)

secure-pi3-1:
	$(call ssh_run,depin-pi3-1,$(PI3_1_IP),$(SCRIPTS)/02-security.sh)

secure-pi3-2:
	$(call ssh_run,depin-pi3-2,$(PI3_2_IP),$(SCRIPTS)/02-security.sh)

secure-pi3-mon:
	$(call ssh_run,depin-pi3-mon,$(PI3_MON_IP),$(SCRIPTS)/02-security.sh)

secure-jetson:
	$(call ssh_run,depin-jetson,$(JETSON_IP),$(SCRIPTS)/02-security.sh)
...
docker-pi4:
	$(call ssh_run,depin-pi4,$(PI4_IP),$(SCRIPTS)/03-docker-install.sh)

docker-pi3-1:
	$(call ssh_run,depin-pi3-1,$(PI3_1_IP),$(SCRIPTS)/03-docker-install.sh)

docker-pi3-2:
	$(call ssh_run,depin-pi3-2,$(PI3_2_IP),$(SCRIPTS)/03-docker-install.sh)

docker-pi3-mon:
	$(call ssh_run,depin-pi3-mon,$(PI3_MON_IP),$(SCRIPTS)/03-docker-install.sh)

docker-jetson:
	$(call ssh_run,depin-jetson,$(JETSON_IP),$(SCRIPTS)/03-docker-install.sh)
...
# =============================================================================
# PHASE 5: Monitoring (depin-pi3-mon only — deploy FIRST)
# =============================================================================
.PHONY: monitoring

monitoring:
	@echo ">>> Deploying monitoring stack on depin-pi3-mon..."
...
exporters-all:
	$(call ssh_run,depin-pi4,$(PI4_IP),$(SCRIPTS)/06-node-exporter.sh)
	$(call ssh_run,depin-pi3-1,$(PI3_1_IP),$(SCRIPTS)/06-node-exporter.sh)
	$(call ssh_run,depin-pi3-2,$(PI3_2_IP),$(SCRIPTS)/06-node-exporter.sh)
	$(call ssh_run,depin-jetson,$(JETSON_IP),$(SCRIPTS)/06-node-exporter.sh)
...
storage-prep:
	$(call ssh_run,depin-pi3-1,$(PI3_1_IP),$(SCRIPTS)/07-storage-prep.sh)

deploy-bandwidth:
	@echo ">>> Deploying bandwidth DePIN on depin-pi4..."
...
deploy-storage:
	@echo ">>> Deploying storage DePIN on depin-pi3-1..."
...
deploy-indexing:
	@echo ">>> Deploying indexing DePIN on depin-pi3-2..."
...
deploy-compute:
	@echo ">>> Deploying compute DePIN on depin-jetson..."
...
rtx-prep:
	$(call ssh_run,rtx-standby,$(RTX_IP),$(SCRIPTS)/12-rtx-standby.sh)
...
help:
	...
	@echo "    deploy-bandwidth  Bandwidth DePIN (depin-pi4)"
	@echo "    deploy-storage    Storage DePIN (depin-pi3-1)"
	@echo "    deploy-indexing   Indexing DePIN (depin-pi3-2)"
	@echo "    deploy-compute    Compute DePIN (depin-jetson)"
